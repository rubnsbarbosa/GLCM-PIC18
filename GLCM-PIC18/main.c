...
void main(){
    ...
    //  calculo do contraste: mede a presenca de transicao abrupta de ni­veis de cinza
    for (i = 0; i < valueLuminance + 1; i++)
    ...
    //  calculo da correlacao: mede a dependencia linear de um nivel de cinza em relacao aos vizinhos
